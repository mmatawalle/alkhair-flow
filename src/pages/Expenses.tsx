    ...
    <div className="page-container">
      ...
      <div className="filter-bar">
        {isSuperAdmin ? (
          ...
          <Badge variant="secondary">Shop expenses only</Badge>
        )}
          ...
          <form onSubmit={(e) => { e.preventDefault(); saveMutation.mutate(); }} className="space-y-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {isSuperAdmin ? (
                ...
                <div>
                  <label className="text-sm text-muted-foreground">Side</label>
                  <div className="flex h-10 items-center rounded-md border border-input bg-muted px-3 text-sm">Shop</div>
                </div>
              )}
              <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {isSuperAdmin ? (
                ...
                <div>
                  <label className="text-sm text-muted-foreground">Payment type</label>
                  <div className="flex h-10 items-center rounded-md border border-input bg-muted px-3 text-sm">Normal</div>
                </div>
              )}
              <div>
